class Worker():
    ...
    def __repr__(self):
        ...
        coord = "\nCoordinates: ("+ self.topLeftCoordinates[0] + "," + self.topLeftCoordinates[1] + ") " + ", (" + self.bottomRightCoordinates[0] + "," + self.bottomRightCoordinates[1] + ") " + self.bottomRightCoordinates+"\n"
        return "--------------------------------"+id+coord+"--------------------------------"
